               ...
               <div id="request" class="main_form">
                  <div class="row" mu>
                     ...
                     <div class="col-md-12" style="display: inline-flex">
                            ...
                            <form  action="<?php echo e(route('profiles.destroy',['id'=>$profile->id])); ?>" method="POST" class="sub_btn btn btn-success-outline">
                              <?php echo csrf_field(); ?>
                        ...
                        <a class="sub_btn btn btn-success-outline" href="<?php echo e(route('profiles.edit',['id'=>$profile->id])); ?>">Edit</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel\projects\moole\resources\views/prof/index.blade.php ENDPATH**/ ?>