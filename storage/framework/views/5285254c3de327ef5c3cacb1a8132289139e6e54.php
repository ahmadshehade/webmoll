        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo e(route('profiles.update'.['profile'=>$profile->id])); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH D:\Laravel\projects\moole\resources\views/profiles/edit.blade.php ENDPATH**/ ?>